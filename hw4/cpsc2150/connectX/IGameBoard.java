...
public interface IGameBoard {
     ...
     * (which was placed in row r, column c and player p) resulted in the player getting num in a row horizontally.
     * Otherwise, it returns false.
     ...
     * @return - returns true or false if there are num of the same token in a row horizontally
     */
